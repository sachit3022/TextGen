...
\begin{document}
    \begin{tikzpicture}[very thick]
        ...
        \draw[->] (d4) -- (d5);
        \draw[->] (d5) -- (d6);
        \draw[->] (d1.north) to [out=45, in=225] (d2.south);
        \draw[->] (d2.north) to [out=45, in=225] (d3.south);
        \draw[->] (d3.north) to [out=45, in=225] (d4.south);
        \draw[->] (d4.north) to [out=45, in=225] (d5.south);
        \draw[->] (d5.north) to [out=45, in=225] (d6.south);
    \end{tikzpicture}
\end{document}